...
print("Is it greater?",5>-2) # 5 is greater than 2 and thus prints True
print("Is it greater or equal?",5>=-2) # Refer Line 21
print("Is it less or equal",5<=-2)# Now this is a False statment and thus it returns False 
